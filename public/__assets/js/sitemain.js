!(function (e, t) {
                        ...
                        (n = s[t]),
                            s !== (i = e[t]) &&
                                (c && i && (_.isPlainObject(i) || (r = Array.isArray(i)))
                                    ? (r ? ((r = !1), (o = n && Array.isArray(n) ? n : [])) : (o = n && _.isPlainObject(n) ? n : {}), (s[t] = _.extend(c, o, i)))
                                    : void 0 !== i && (s[t] = i));
            return s;
        }),
        _.extend({
    ...
    var x = (function (e) {
        ...
        (oe.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== d && h(e), (t = t.replace(z, "='$1']")), n.matchesSelector && g && !S[t + " "] && (!v || !v.test(t)) && (!m || !m.test(t))))
                try {
                    var i = y.call(e, t);
                        ...
                        : function (t, n, l) {
                              ...
                              if (m) {
                                  ...
                                  if (((p = [s ? m.firstChild : m.lastChild]), s && y)) {
                                      for (
                                          b = (d = (c = (u = (f = (h = m)[_] || (h[_] = {}))[h.uniqueID] || (f[h.uniqueID] = {}))[e] || [])[0] === E && c[1]) && c[2], h = d && m.childNodes[d];
                                      ...
                                      for (
                                          ;
                                          (h = (++d && h && h[g]) || (b = d = 0) || p.pop()) &&
                                          ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++b || (y && ((u = (f = h[_] || (h[_] = {}))[h.uniqueID] || (f[h.uniqueID] = {}))[e] = [E, b]), h !== t));
        ...
        return (
            ...
            (s = oe.tokenize = function (e, t) {
                ...
                for (a = e, l = [], c = i.preFilter; a; ) {
                    ...
                    (n = !1),
                    (r = U.exec(a)) && ((n = r.shift()), o.push({ value: n, type: r[0].replace(W, " ") }), (a = a.slice(n.length))),
                    i.filter))
                        !(r = Q[s].exec(a)) || (c[s] && !(r = c[s](r))) || ((n = r.shift()), o.push({ value: n, type: s, matches: r }), (a = a.slice(n.length)));
                    if (!n) break;
                }
                                        ...
                                        c = function () {
                                            ...
                                            if (!(t < o)) {
                                                ...
                                                (c = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                    g(c)
                                                        ? r
                                                            ? c.call(e, s(o, n, H, r), s(o, n, M, r))
                                                            : (o++, c.call(e, s(o, n, H, r), s(o, n, M, r), s(o, n, H, n.notifyWith)))
                                                        : (i !== H && ((a = void 0), (l = [e])), (r || n.resolveWith)(a, l));
                                            }
                                        },
                                        u = r
                                            ? c
    ...
    var B = function (e, t, n, i, r, o, s) {
            var a = 0,
                l = e.length,
                c = null == n;
            if ("object" === b(n)) for (a in ((r = !0), n)) B(e, t, a, n[a], !0, o, s);
            else if (
                void 0 !== i &&
                ((r = !0),
                g(i) || (s = !0),
    ...
    function oe(e, t, n, i) {
        ...
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; s--; ) _.style(e, t, u + c), (1 - o) * (1 - (o = a() / l || 0.5)) <= 0 && (s = 0), (u /= o);
    ...
    function le(e, t) {
        for (var n, i, r = [], o = 0, s = e.length; o < s; o++)
            (i = e[o]).style &&
                ((n = i.style.display),
                t ? ("none" === n && ((r[o] = K.get(i, "display") || null), r[o] || (i.style.display = "")), "" === i.style.display && ie(i) && (r[o] = ae(i))) : "none" !== n && ((r[o] = "none"), K.set(i, "display", n)));
    ...
    function me(e, t, n, i, r) {
        ...
        for (f.textContent = "", d = 0; (o = h[d++]); )
            ...
            else if (((c = _.contains(o.ownerDocument, o)), (s = de(f.appendChild(o), "script")), c && pe(s), n)) for (u = 0; (o = s[u++]); ) fe.test(o.type || "") && n.push(o);
        return f;
    }
    !(function () {
                ...
                for (
                    ...
                    (d = g = (a = _e.exec(t[c]) || [])[1]),
                        ...
                        d &&
                            ...
                            (f = _.event.special[d] || {}),
                            (u = _.extend({ type: d, origType: g, data: i, handler: n, guid: n.guid, selector: r, needsContext: r && _.expr.match.needsContext.test(r), namespace: p.join(".") }, o)),
                            (h = l[d]) || (((h = l[d] = []).delegateCount = 0), (f.setup && !1 !== f.setup.call(e, i, p, s)) || (e.addEventListener && e.addEventListener(d, s))),
        ...
        remove: function (e, t, n, i, r) {
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(P) || [""]).length; c--; )
                    if (((d = g = (a = _e.exec(t[c]) || [])[1]), (p = (a[2] || "").split(".").sort()), d)) {
                        for (f = _.event.special[d] || {}, h = l[(d = (i ? f.delegateType : f.bindType) || d)] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = h.length; o--; )
                            (u = h[o]),
                                (!r && g !== u.origType) ||
                                    (n && n.guid !== u.guid) ||
                                    (a && !a.test(u.namespace)) ||
                                    (i && i !== u.selector && ("**" !== i || !u.selector)) ||
                                    (h.splice(o, 1), u.selector && h.delegateCount--, f.remove && f.remove.call(e, u));
    ...
    function Le(e, t, n, i) {
        ...
        if (h && ((o = (r = me(t, e[0].ownerDocument, !1, e, i)).firstChild), 1 === r.childNodes.length && (r = o), o || i)) {
            ...
            if (l)
                for (u = a[a.length - 1].ownerDocument, _.map(a, Ie), f = 0; f < l; f++)
                    (c = a[f]), fe.test(c.type || "") && !K.access(c, "globalEval") && _.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? _._evalUrl && _._evalUrl(c.src) : y(c.textContent.replace(De, ""), u, c));
        }
        return e;
    }
    function Pe(e, t, n) {
    ...
    _.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n) for (o = o || de(e), s = s || de(a), i = 0, r = o.length; i < r; i++) Oe(o[i], s[i]);
                else Oe(e, a);
    ...
    function Re(e, t, n) {
        ...
        return (
            (n = n || Me(e)) &&
                ("" !== (s = n.getPropertyValue(t) || n[t]) || _.contains(e.ownerDocument, e) || (s = _.style(e, t)),
                !p.pixelBoxStyles() && He.test(s) && qe.test(t) && ((i = a.width), (r = a.minWidth), (o = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = r), (a.maxWidth = o))),
            void 0 !== s ? s + "" : s
        );
    }
    function Fe(e, t) {
    ...
    function Ke(e, t, n, i, r, o) {
        ...
        for (; s < 4; s += 2)
            "margin" === n && (l += _.css(e, n + ne[s], !0, r)),
                i
                    ? ("content" === n && (l -= _.css(e, "padding" + ne[s], !0, r)), "margin" !== n && (l -= _.css(e, "border" + ne[s] + "Width", !0, r)))
                    : ((l += _.css(e, "padding" + ne[s], !0, r)), "padding" !== n ? (l += _.css(e, "border" + ne[s] + "Width", !0, r)) : (a += _.css(e, "border" + ne[s] + "Width", !0, r)));
    ...
    _.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (o = typeof n) && (r = te.exec(n)) && r[1] && ((n = oe(e, t, r)), (o = "number")),
                    null != n &&
                        n == n &&
                        ("number" === o && (n += (r && r[3]) || (_.cssNumber[a] ? "" : "px")),
        ...
        _.each(["height", "width"], function (e, t) {
            _.cssHooks[t] = {
                get: function (e, n, i) {
                    if (n)
                        return !We.test(_.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width)
                            ? Xe(e, t, i)
                            : re(e, Ue, function () {
                                  return Xe(e, t, i);
                              });
                ...
                set: function (e, n, i) {
                    var r,
                        ...
                        a = i && Ke(e, t, i, s, o);
                    return (
                        s && p.scrollboxSize() === o.position && (a -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Ke(e, t, "border", !1, o) - 0.5)),
    ...
    function st(e, t, n) {
        ...
        for (
            (function (e, t) {
                var n, i, r, o, s;
                for (n in e)
                    if (((r = t[(i = $(n))]), (o = e[n]), Array.isArray(o) && ((r = o[1]), (o = e[n] = o[0])), n !== i && ((e[i] = o), delete e[n]), (s = _.cssHooks[i]) && ("expand" in s)))
            ...
            if ((i = st.prefilters[o].call(c, e, u, c.opts))) return g(i.stop) && (_._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return (
            _.map(u, ot, c),
            ...
            function (e, t, n) {
                ...
                if ((l = !_.isEmptyObject(t)) || !_.isEmptyObject(d))
                    for (i in (f &&
                        ...
                        "none" === (u = _.css(e, "display")) && (c ? (u = c) : (le([e], !0), (c = e.style.display || c), (u = _.css(e, "display")), le([e]))),
            ...
            stop: function (e, t, n) {
                ...
                return (
                    ...
                    this.each(function () {
                        ...
                        else for (r in s) s[r] && s[r].stop && tt.test(r) && i(s[r]);
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ? _.prop(e, t, n)
                        : ((1 === o && _.isXMLDoc(e)) || (r = _.attrHooks[t.toLowerCase()] || (_.expr.match.bool.test(t) ? at : void 0)),
                          void 0 !== n
                              ? null === n
    ...
    _.fn.extend({
        ...
        _.extend({
            prop: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return (
                        (1 === o && _.isXMLDoc(e)) || ((t = _.propFix[t] || t), (r = _.propHooks[t])),
        ...
        _.fn.extend({
            ...
            toggleClass: function (e, t) {
                ...
                return "boolean" == typeof t && i
                    ...
                    : this.each(function () {
                          var t, r, o, s;
                          if (i) for (r = 0, o = _(this), s = dt(e); (t = s[r++]); ) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                          else (void 0 !== e && "boolean" !== n) || ((t = ht(this)) && K.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : K.get(this, "__className__") || ""));
                      });
            },
            hasClass: function (e) {
                var t,
    ...
    _.fn.extend({
        val: function (e) {
            ...
            return arguments.length
                ...
                : r
                ? (t = _.valHooks[r.type] || _.valHooks[r.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(r, "value"))
                    ? n
            ...
            if (
                ...
                for (s = 0; (a = v[s++]) && !t.isPropagationStopped(); )
                    (p = a),
                        ...
                        (h = u && a[u]) && h.apply && Q(a) && ((t.result = h.apply(a, n)), !1 === t.result && t.preventDefault());
                return (
                    (t.type = y),
                    o ||
    ...
    (Lt.href = vt.href),
        _.extend({
            ...
            ajax: function (t, n) {
                ...
                (o = p.url.replace(St, "")),
                p.hasContent
                    ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Ct, "+"))
                    : ((d = p.url.slice(o.length)),
                      p.data && (p.processData || "string" == typeof p.data) && ((o += (bt.test(o) ? "&" : "?") + p.data), delete p.data),
                      !1 === p.cache && ((o = o.replace(At, "$1")), (d = (bt.test(o) ? "&" : "?") + "_=" + yt++ + d)),
                      (p.url = o + d)),
                p.ifModified && (_.lastModified[o] && T.setRequestHeader("If-Modified-Since", _.lastModified[o]), _.etag[o] && T.setRequestHeader("If-None-Match", _.etag[o])),
                ...
                function C(t, n, i, a) {
                    ...
                    u ||
                        ...
                        c
                            ? (p.ifModified && ((E = T.getResponseHeader("Last-Modified")) && (_.lastModified[o] = E), (E = T.getResponseHeader("etag")) && (_.etag[o] = E)),
                              204 === t || "HEAD" === p.type ? (x = "nocontent") : 304 === t ? (x = "notmodified") : ((x = w.state), (h = w.data), (c = !(d = w.error))))
                        ...
                        y.fireWith(g, [T, x]),
                        f && (m.trigger("ajaxComplete", [T, p]), --_.active || _.event.trigger("ajaxStop")));
                }
                return T;
            },
                            ...
                            return function () {
                                n &&
                                    ...
                                    "abort" === e
                                        ...
                                        : o(qt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? { binary: a.response } : { text: a.responseText }, a.getAllResponseHeaders()));
                            };
                        }),
                            (a.onload = n()),
        ...
        (_.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  t || (p.createHTMLDocument ? (((r = (t = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href), t.head.appendChild(r)) : (t = i)),
                  (s = !n && []),
                  (o = D.exec(e)) ? [t.createElement(o[1])] : ((o = me([e], t, s)), s && s.length && _(s).remove(), _.merge([], o.childNodes)));
            var r, o, s;
        }),
    ...
    (function (e, t) {
        ...
        var q = "collapse",
            ...
            z = { SHOW: "show" + F, SHOWN: "shown" + F, HIDE: "hide" + F, HIDDEN: "hidden" + F, CLICK_DATA_API: "click" + F + ".data-api" },
            V = "show",
            $ = "collapse",
            Q = "collapsing",
            Y = "collapsed",
        ...
        function pe(e, t, n, i) {
            return Math.max(
                ...
                n["offset" + e],
                n["scroll" + e],
                le(10) ? parseInt(n["offset" + e]) + parseInt(i["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(i["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0
            );
        }
        function ge(e) {
            var t = e.body,
                        ...
                        fn: function (e, t) {
                            ...
                            var s,
                                ...
                                S =
                                    ...
                                    (b = a ? f : d),
                                    { left: (y = a ? (m || v || p % 2 == g % 2 ? f : h) : d)(p % 2 == 1 && g % 2 == 1 && !v && a ? c.left - 1 : c.left), top: b(c.top), bottom: b(c.bottom), right: y(c.right) }),
                                A = "bottom" === n ? "top" : "bottom",
                                D = "right" === i ? "left" : "right",
                                k = Oe("transform");
                            if (
                                ((w = "bottom" === A ? ("HTML" === x.nodeName ? -x.clientHeight + S.bottom : -T.height + S.bottom) : S.top),
                                (_ = "right" === D ? ("HTML" === x.nodeName ? -x.clientWidth + S.right : -T.width + S.right) : S.left),
                                E && k)
                            )
                                (C[k] = "translate3d(" + _ + "px, " + w + "px, 0)"), (C[A] = 0), (C[D] = 0), (C.willChange = "transform");
                            else {
                                var N = "bottom" === A ? -1 : 1,
                                    I = "right" === D ? -1 : 1;
        ...
        var Ue = "dropdown",
            ...
            Ke = { HIDE: "hide" + Ve, HIDDEN: "hidden" + Ve, SHOW: "show" + Ve, SHOWN: "shown" + Ve, CLICK: "click" + Ve, CLICK_DATA_API: "click" + Ve + $e, KEYDOWN_DATA_API: "keydown" + Ve + $e, KEYUP_DATA_API: "keyup" + Ve + $e },
            Xe = "disabled",
            Ge = "show",
            ...
            it = (function () {
                ...
                return (
                            ...
                            if ((e._clearMenus(), !i)) {
                                ...
                                if ((t(n).trigger(o), !o.isDefaultPrevented())) {
                                    if (!this._inNavbar) {
                                        ...
                                        var a = this._element;
                                        "parent" === this._config.reference ? (a = n) : s.isElement(this._config.reference) && ((a = this._config.reference), void 0 !== this._config.reference.jquery && (a = this._config.reference[0])),
                    ...
                    (n._getPlacement = function () {
                        ...
                        return (
                            e.hasClass("dropup")
                                ? ((n = "top-start"), t(this._menu).hasClass(Je) && (n = "top-end"))
                                : e.hasClass("dropright")
                                ? (n = "right-start")
                                : e.hasClass("dropleft")
                                ? (n = "left-start")
                                : t(this._menu).hasClass(Je) && (n = "bottom-end"),
                            n
                        );
                    }),
                    ...
                    (e._dataApiKeydownHandler = function (n) {
                        if (
                            (/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || (27 !== n.which && ((40 !== n.which && 38 !== n.which) || t(n.target).closest(et).length))) : Ye.test(n.which)) &&
                            (n.preventDefault(), n.stopPropagation(), !this.disabled && !t(this).hasClass(Xe))
                        ) {
        ...
        t(document)
            .on(Ke.KEYDOWN_DATA_API, Ze, it._dataApiKeydownHandler)
            .on(Ke.KEYDOWN_DATA_API, et, it._dataApiKeydownHandler)
            .on(Ke.CLICK_DATA_API + " " + Ke.KEYUP_DATA_API, it._clearMenus)
            .on(Ke.CLICK_DATA_API, Ze, function (e) {
            ...
            vt = (function () {
                ...
                return (
                    ...
                    (n._showElement = function (e) {
                        ...
                        var r = t.Event(ut.SHOWN, { relatedTarget: e }),
                            o = function () {
                    ...
                    (n._setEscapeEvent = function () {
                        ...
                        this._isShown && this._config.keyboard
                            ? t(this._element).on(ut.KEYDOWN_DISMISS, function (t) {
                    ...
                    (n._setResizeEvent = function () {
                        var e = this;
                        this._isShown
                            ? t(window).on(ut.RESIZE, function (t) {
        ...
        var Et = "tooltip",
            ...
            Nt = { AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left" },
            It = {
                animation: !0,
                ...
                return (
                    ...
                    (n.setElementContent = function (e, n) {
                        "object" != typeof n || (!n.nodeType && !n.jquery)
                            ? this.config.html
                                ? (this.config.sanitize && (n = wt(n, this.config.whiteList, this.config.sanitizeFn)), e.html(n))
                                : e.text(n)
                            : this.config.html
                    ...
                    (n._enter = function (e, n) {
                        ...
                        (n = n || t(e.currentTarget).data(i)) || ((n = new this.constructor(e.currentTarget, this._getDelegateConfig())), t(e.currentTarget).data(i, n)),
                            ...
                            t(n.getTipElement()).hasClass(Pt) || n._hoverState === Ot
                                ? (n._hoverState = Ot)
        ...
        var Rt = "popover",
            ...
            Vt = r({}, qt.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
            $t = r({}, qt.DefaultType, { content: "(string|element|function)" }),
            Qt = {
                HIDE: "hide" + Wt,
                HIDDEN: "hidden" + Wt,
                SHOW: "show" + Wt,
                ...
                return (
                    ...
                    (n._activate = function (e) {
                        ...
                        i.hasClass("dropdown-item")
                            ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(nn), i.addClass(nn))
                            : (i.addClass(nn),
                              i
                                  .parents(rn)
                                  .prev(on + ", " + sn)
                            ...
                            t(this._scrollElement).trigger(tn.ACTIVATE, { relatedTarget: e });
                    }),
                    (n._clear = function () {
                        [].slice
                            .call(document.querySelectorAll(this._selector))
        ...
        var un = "bs.tab",
            fn = "." + un,
            hn = t.fn.tab,
            dn = { HIDE: "hide" + fn, HIDDEN: "hidden" + fn, SHOW: "show" + fn, SHOWN: "shown" + fn, CLICK_DATA_API: "click" + fn + ".data-api" },
            pn = "active",
            gn = ".active",
            mn = "> li > .active",
            vn = (function () {
                ...
                return (
                    (n.show = function () {
                        ...
                        if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(pn)) || t(this._element).hasClass("disabled"))) {
                            ...
                            var l = t.Event(dn.HIDE, { relatedTarget: this._element }),
                                c = t.Event(dn.SHOW, { relatedTarget: i });
        ...
        var yn = "toast",
            ...
            _n = "." + bn,
            wn = t.fn[yn],
            En = { CLICK_DISMISS: "click.dismiss" + _n, HIDE: "hide" + _n, HIDDEN: "hidden" + _n, SHOW: "show" + _n, SHOWN: "shown" + _n },
            xn = "show",
            Tn = "showing",
                ...
                return (
                    ...
                    (n.hide = function (e) {
                        ...
                        this._element.classList.contains(xn) &&
                            (t(this._element).trigger(En.HIDE),
                            e
                                ? this._close()
        ...
        return (function (e) {
            ...
            function (e, t, n) {
                ...
                t.default = (function () {
                    if ("undefined" != typeof window) {
                        var e = { history: [] },
                            t = { offset: {}, threshold: 0, test: s.inViewport },
            ...
            function (e, t, n) {
                ...
                e.exports = function (e, t, n) {
                    ...
                    return (
                        (t = o(t) || 0),
                        i(n) && ((w = !!n.leading), (m = (E = "maxWait" in n) ? a(o(n.maxWait) || 0, t) : m), (x = "trailing" in n ? !!n.trailing : x)),
                        (d.cancel = function () {
            ...
            function (e, t, n) {
                ...
                e.exports = function (e, t, n) {
                    ...
                    return r(n) && ((s = "leading" in n ? !!n.leading : s), (a = "trailing" in n ? !!n.trailing : a)), i(e, t, { leading: s, maxWait: t, trailing: a });
                };
            },
            function (e, t) {
                e.exports = function (e) {
                                ...
                                if (
                                    ...
                                    (S = function () {
                                        ...
                                        if (
                                            ...
                                            (d = C.offset().top + e + t),
                                            (p = C.height()),
                                            w && ((b = w = !1), null == s && (n.insertAfter(k), k.detach()), n.css({ position: "", top: "", width: "", bottom: "" }).removeClass(f), (r = !0)),
                                            (g = n.offset().top - (parseInt(n.css("margin-top"), 10) || 0) - a),
                                            (m = n.outerHeight(!0)),
                                            (v = n.css("float")),
                                            k && k.css({ width: l(n), height: m, display: n.css("display"), "vertical-align": n.css("vertical-align"), float: v }),
                                            r)
                                        )
                                            return N();
                                    })(),
                                    ...
                                    return (
                                        ...
                                        (N = function () {
                                            ...
                                            if (
                                                !y &&
                                                ((c = !1),
                                                null != D && 0 >= --D && ((D = u), S(), (c = !0)),
                                                c || i.height() === x || S(),
                                                (c = t.scrollTop()),
                                                null != E && (l = c - E),
                                                (E = c),
                                                w
                                                    ? (r && ((_ = c + m + T > p + d), b && !_ && ((b = !1), n.css({ position: "fixed", bottom: "", top: T }).trigger("sticky_kit:unbottom"))),
                                                      c < g &&
                                                          ((w = !1),
                                                          (T = a),
                                                          null == s && (("left" !== v && "right" !== v) || n.insertAfter(k), k.detach()),
                                                          (e = { position: "", width: "", top: "" }),
                                                          n.css(e).removeClass(f).trigger("sticky_kit:unstick")),
                                                      o && ((e = t.height()), m + a > e && !b && ((T -= l), (T = Math.max(e - m, T)), (T = Math.min(a, T)), w && n.css({ top: T + "px" }))))
                                                    : c > g &&
                                                      ((w = !0),
                                                      ((e = { position: "fixed", top: T }).width = "border-box" === n.css("box-sizing") ? n.outerWidth() + "px" : n.width() + "px"),
                                                      n.css(e).addClass(f),
                                                      null == s && (n.after(k), ("left" !== v && "right" !== v) || k.append(n)),
                                                      n.trigger("sticky_kit:stick")),
                                                w && r && (null == _ && (_ = c + m + T > p + d), !b && _))
                                            )
                                                return (b = !0), "static" === C.css("position") && C.css({ position: "relative" }), n.css({ position: "absolute", bottom: h, top: "auto" }).trigger("sticky_kit:bottom");
                                        }),
                                        (A = function () {
                                            return S(), N();
                                        }),
                                        (_ = function () {
                                            if (
                                                ...
                                                return null == s && (("left" !== v && "right" !== v) || n.insertAfter(k), k.remove()), n.removeClass(f);
                                        }),
                                        t.on("touchmove", N),
                                        t.on("scroll", N),
                                        t.on("resize", A),
                    ...
                    (r.onreadystatechange = function () {
                        if (4 === r.readyState) {
                            if (404 === r.status || null === r.responseXML)
                                return i("Unable to load SVG file: " + t), n && i("Note: SVG injection ajax calls do not work locally without adjusting security setting in your browser. Or consider using a local webserver."), i(), !1;
                        ...
                        -1 === a.indexOf(t) &&
                            ...
                            h(u, function (i) {
                                ...
                                for (var w, E, x = i.querySelectorAll("script"), T = [], C = 0, S = x.length; S > C; C++)
                                    ((E = x[C].getAttribute("type")) && "application/ecmascript" !== E && "application/javascript" !== E) || ((w = x[C].innerText || x[C].textContent), T.push(w), i.removeChild(x[C]));
        ...
        function t(t) {
            ...
            if (!i.data.outer) {
                ...
                (i.data.inner = e("<div>").css(e.extend({}, n))),
                    (i.data.outer = e("<div>")
                        .css(e.extend({ left: "-1000px", overflow: "scroll", position: "absolute", top: "-1000px" }, n))
                        .append(i.data.inner)
                        .appendTo("body"));
            }
            return i.data.outer.scrollLeft(1e3).scrollTop(1e3), { height: Math.ceil(i.data.outer.offset().top - i.data.inner.offset().top || 0), width: Math.ceil(i.data.outer.offset().left - i.data.inner.offset().left || 0) };
        }
        function n(e) {
        ...
        o.prototype = {
            destroy: function () {
                if (this.wrapper) {
                    ...
                    this.container.insertBefore(this.wrapper).css({ height: "", margin: "", "max-height": "" }).removeClass("scroll-content scroll-scrollx_visible scroll-scrolly_visible").off(this.namespace).scrollLeft(t).scrollTop(n),
            ...
            init: function (t) {
                ...
                if (u) ((f = { height: "auto", "margin-bottom": -1 * i.scroll.height + "px", "max-height": "" })[l.isRtl ? "margin-left" : "margin-right"] = -1 * i.scroll.width + "px"), s.css(f);
                else {
                    if (
                        ((this.wrapper = u = e("<div>")
                            .addClass("scroll-wrapper")
                            .addClass(o.attr("class"))
                            .css("position", "absolute" === o.css("position") ? "absolute" : "relative")
                            .insertBefore(o)
                            .append(o)),
                        l.isRtl && u.addClass("scroll--rtl"),
                        o.is("textarea") && ((this.containerWrapper = s = e("<div>").insertBefore(o).append(o)), u.addClass("scroll-textarea")),
                        ((f = { height: "auto", "margin-bottom": -1 * i.scroll.height + "px", "max-height": "" })[l.isRtl ? "margin-left" : "margin-right"] = -1 * i.scroll.width + "px"),
                        ...
                        o.on("scroll" + a, function (t) {
                            ...
                            e.isFunction(l.onScroll) &&
                                l.onScroll.call(r, { maxScroll: c.y.maxScrollOffset, scroll: s, size: c.y.size, visible: c.y.visible }, { maxScroll: c.x.maxScrollOffset, scroll: n, size: c.x.size, visible: c.x.visible }),
                ...
                e.each(c, function (t, s) {
                    var u = null,
                        ...
                        g = 0;
                    s.scroll ||
                        ((s.scroll = r._getScroll(l["scroll" + t]).addClass("scroll-" + t)),
                        ...
                        (s.mousewheel = function (e) {
                            ...
                            return (
                                i || ("x" === t && e.originalEvent.deltaX ? (i = 40 * e.originalEvent.deltaX) : "y" === t && e.originalEvent.deltaY && (i = 40 * e.originalEvent.deltaY)),
                                ((i > 0 && g < a) || (i < 0 && g > 0)) &&
                                    ((g += i) < 0 && (g = 0),
                                    g > a && (g = a),
                                    ...
                                    setTimeout(function () {
                                        r.scrollTo &&
                                            (o.stop().animate(r.scrollTo, 240, "linear", function () {
                                                g = o[h]();
                                            }),
                                            (r.scrollTo = null));
                                    }, 1)),
                        ...
                        s.scroll
                            .on("MozMousePixelScroll" + a, s.mousewheel)
                            .on("mousewheel" + a, s.mousewheel)
                        ...
                        s.scroll.find(".scroll-arrow, .scroll-element_track").on("mousedown" + a, function (n) {
                            ...
                            if (e(this).hasClass("scroll-arrow")) {
                                if (((f = e(this).hasClass("scroll-arrow_more") ? 1 : -1), (d = l.scrollStep * f), (g = f > 0 ? a.maxScrollValue : 0), l.isRtl))
                                    switch (!0) {
                                        case i.firefox:
                            ...
                            } else (f = a.eventOffset > a.scrollbarOffset + a.scrollbarSize ? 1 : a.eventOffset < a.scrollbarOffset ? -1 : 0), "x" === t && l.isRtl && (i.msie || i.msedge) && (f *= -1), (d = Math.round(0.75 * s.visible) * f), (g = a.eventOffset - a.scrollbarOffset - (l.stepScrolling ? (1 == f ? a.scrollbarSize : 0) : Math.round(a.scrollbarSize / 2))), (g = o[h]() + g / s.kx);
                            return (
                                (r.scrollTo = r.scrollTo || {}),
                    ...
                    e.each(c, function (t, n) {
                        e.extend(n, "x" == t ? { offset: parseInt(o.css("left"), 10) || 0, size: o.prop("scrollWidth"), visible: u.width() } : { offset: parseInt(o.css("top"), 10) || 0, size: o.prop("scrollHeight"), visible: u.height() });
                    }),
                    ...
                    e.each(c, function (e, t) {
                        ...
                        l.autoScrollSize && ((t.scrollbarSize = parseInt((u * c) / a, 10)), t.scroll.bar.css(r, t.scrollbarSize + "px")),
            ...
            _updateScroll: function (t, n) {
                var r = this.container,
                    ...
                    f = n.visible + l;
                (n.isVisible = u - f > 1),
                    n.isVisible ? (n.scroll.addClass(s), a.scroll.addClass(s), o.addClass(s)) : (n.scroll.removeClass(s), a.scroll.removeClass(s), o.removeClass(s)),
                    "y" === t && (r.is("textarea") || u < f ? o.css({ height: f + i.scroll.height + "px", "max-height": "none" }) : o.css({ "max-height": f + i.scroll.height + "px" })),
                    (n.size == r.prop("scrollWidth") &&
                        a.size == r.prop("scrollHeight") &&
                        n.visible == c.width() &&
                        a.visible == c.height() &&
                        n.offset == (parseInt(r.css("left"), 10) || 0) &&
                        a.offset == (parseInt(r.css("top"), 10) || 0)) ||
                        (e.extend(this.scrollx, { offset: parseInt(r.css("left"), 10) || 0, size: r.prop("scrollWidth"), visible: c.width() }),
                        e.extend(this.scrolly, { offset: parseInt(r.css("top"), 10) || 0, size: this.container.prop("scrollHeight"), visible: c.height() }),
            ...
            return function (t) {
                ...
                for (n = 0; n < i.scrolls.length; n++)
                    (r = (s = i.scrolls[n]).container),
                        ...
                        (c = s.scrollx),
                        (u = s.scrolly),
                        (t || (o.autoUpdate && l && l.is(":visible") && (r.prop("scrollWidth") != c.size || r.prop("scrollHeight") != u.size || l.width() != c.visible || l.height() != u.visible))) &&
                            (s.init(),
                            o.debug &&
                                (window.console &&
                                    console.log(
        ...
        var t,
            ...
            c = function (t, n) {
                var i,
                    ...
                    c = 0;
                return (
                    "wheel" === t.type ? ((i = n.height() / e(window).height()), (c = t.originalEvent.deltaY * i)) : this.options.touch && "touchmove" === t.type && (l = t.originalEvent.changedTouches[0].clientY - this.startClientY),
                    { prevent: (r = l > 0 && o + c <= 0) || (l < 0 && o + c >= s - a), top: r, scrollTop: o, deltaY: c }
                );
            },
            u = function (e, t) {
                var c,
                    ...
                    h = { top: !1, bottom: !1 };
                return (
                    (h.top = 0 === f && (e.keyCode === i || e.keyCode === s || e.keyCode === a)),
                    h.top || ((c = t.prop("scrollHeight")), (u = t.prop("clientHeight")), (h.bottom = c === f + u && (e.keyCode === n || e.keyCode === r || e.keyCode === o || e.keyCode === l))),
                    h
                );
            },
            f = function (t, n) {
                (this.$element = t),
                    ...
                    this.options.touch &&
                        (this.$element.on("touchstart" + f.NAMESPACE, this.options.selector, e.proxy(f.CORE.touchHandler, this)),
            ...
            (f.CORE = {
                ...
                handler: function (t) {
                    ...
                    this.enabled &&
                        !t.ctrlKey &&
                        ((n = e(t.currentTarget)),
                        (!0 !== this.options.strict || this.options.strictFn(n)) &&
                            (t.stopPropagation(),
                ...
                animationHandler: function (e, t) {
                    ...
                    e.off(f.ANIMATION_NAMESPACE)
                        .removeClass(i)
                        .addClass(n)
                        .one(f.CORE.animationEventName, function () {
                            e.removeClass(n);
                        });
                },
                keyboardHandler: function (t) {
                    var n,
                        ...
                        r = (i.scrollTop(), u(t, i));
                    return (
                        t.__currentTarget && ((n = u(t, e(t.__currentTarget))), (r.top &= n.top), (r.bottom &= n.bottom)),
                        r.top
                            ? (i.trigger(e.Event("top" + f.NAMESPACE)), this.options.animation && setTimeout(f.CORE.animationHandler.bind(this, i, "top"), 0), !1)
                            : r.bottom
                            ? (i.trigger(e.Event("bottom" + f.NAMESPACE)), this.options.animation && setTimeout(f.CORE.animationHandler.bind(this, i, "bottom"), 0), !1)
                            : void 0
                    );
                },
            }),
