                                        ...
                                        <tr>
                                            <td style="width:300px;">
                                                @if($order->status == 'Cancel Order')
                                                    <img alt="" height="auto" src="{{asset('custom/img/cancel-order.png')}}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="300"/>
                                                @else
                                                    <img alt="" height="auto" src="{{asset('custom/img/delivery-order.png')}}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="300"/>
                                                @endif
                                            </td>
                                        </tr>
                                        </tbody>
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                    <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                        <h1 style="text-align:center; color: #000000; line-height:32px">{{__('Your Order is')}} {{($order->status == 'Cancel Order')?__('Canceled'):__('Delivered')}}!</h1>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                @if($order->status == 'Cancel Order')
                                    <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                        <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                            <p style="margin: 10px 0; text-align: center;">{{__('Thank you')}}.&nbsp;</p>
                                ...
                                @else
                                    <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                        <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                            <p style="margin: 10px 0; text-align: center;">{{__('Hi')}} {{$order['name']}}, {{__('Thank you for Shopping')}}.&nbsp;</p>
                                            <p style="margin: 10px 0; text-align: center;"></p>
                                        </div>
                                    </td>
                                @endif
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                        <tr>
                                            <td align="center" bgcolor="#DEDEDE" role="presentation" style="border:none;border-radius:100px;cursor:auto;padding:15px 25px 15px 25px;background:#DEDEDE;" valign="middle">
                                                <a href="{{route('user.order',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($order['id'])])}}" style="background:#DEDEDE;color:#222222;font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank">
